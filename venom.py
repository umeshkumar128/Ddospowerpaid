...
TOKEN = '7110052696:AAEeBalVYQk_o0XOfgyh7w4qWPDNTXYmBi4'
MONGO_URI = 'mongodb+srv://ankitddos@cluster0.ythilmw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0&tlsAllowInvalidCertificates=true'
FORWARD_CHANNEL_ID =  -1001941447950
CHANNEL_ID =  -1001941447950
error_channel_id =  -1001941447950
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.reply_to(message, "*Contact admin @AnkitMor1*", parse_mode='Markdown')
    else:
